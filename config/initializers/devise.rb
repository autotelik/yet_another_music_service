...
Devise.setup do |config|
  ...
  # config.secret_key = 'bc4721fc6242f2ef25abcb42ec3bb16052a9cdd696af305d6204cc81fc29e84f96f49bba9304dbef21a75d4fd8b4b807436ce314ab34fa0ca531460ef9a734e7'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'no-reply@yams.fm'
  ...
  # config.pepper = 'ca9a45eff2e137e0a1571c772e8b16ac12e120c7bb0e18c6532c5903b03fd2e0ae8271c047d1aa7d0781978ab754d7e25b5ae4a1644045a6e16fcf35772326db'
  ...
  # Resend invitation if users with invited status is invited again
  # Default: true
  ...
  # Auto-login after the users accepts the invite. If this is false,
  # the users will need to manually log in after accepting the invite.
  # Default: true
  ...
  config.password_length = (ENV.fetch('YAMS_MINIMUM_PASSWORD_LENGTH', 6).to_i)..128
